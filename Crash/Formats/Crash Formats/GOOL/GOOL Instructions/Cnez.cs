namespace Crash.GOOLIns
{
    ...
    public sealed class Cnez : GOOLInstruction
    {
        ...
        public override string Format => "SSSSSSSSSS AAAA (RRRRRR) 10 10";
        public override string Comment => $"if {(ObjectFields)Args['R'].Value} is true, change to state {GetArg('S')} with {GetArg('A')} arguments";
    }
}
