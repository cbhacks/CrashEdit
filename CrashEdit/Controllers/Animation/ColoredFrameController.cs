...
namespace CrashEdit
{
    public sealed class ColoredFrameController : Controller
    {
        ...
        public void ToOBJ(string path, string modelname)
        {
            ...
            var model = this.ColorAnimationEntryController.NSF.GetEntry<OldModelEntry>(OldFrame.ModelEID);
            ...
            foreach (OldModelPolygon polygon in model.Polygons)
            {
                ...
                if (str is OldModelTexture t)
                {
                    ...
                    if (material is null)
                    {
                        ...
                        var tpag = this.ColorAnimationEntryController.NSF.GetEntry <TextureChunk> (t.EID);
