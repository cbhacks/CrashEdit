...
namespace CrashEdit
{
    public sealed class OldGOOLBox : UserControl
    {
        ...
        public OldGOOLBox(OldT11Entry goolentry)
        {
            ...
            lstCode.Items.Add(string.Format("Stack Start: {0} ({1})",(ObjFields)BitConv.FromInt32(goolentry.Items[0],12),GetNumber(BitConv.FromInt32(goolentry.Items[0],12)*4+0x60)));
